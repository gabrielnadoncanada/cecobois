...
?>
    ...
    <script type="text/javascript" src="/calculatrices-en-ligne/js/calculators/colonnes-imperial/script.js" language="javascript"></script>
    <script type="text/javascript" src="/calculatrices-en-ligne/js/calculators/colonnes-imperial/swap_systeme.js" language="javascript"></script>
</body>
</html>