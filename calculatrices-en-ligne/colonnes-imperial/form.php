	...
	<div class="form">
		<form name="calcul" method="post" id="calc">
			<fieldset class="item-container">
				...
				<ul id="bois_sciage"<?php echo $html_classe_bois_sciage_style;?>>
					...
					<li>
						...
						<?php HtmlOutput::select('colonnes_bois_sciage2',$html_colonnes_bois_sciage2,$html_colonnes_bois_sciage_value2,$html_colonnes_bois_sciage2_js,$html_colonnes_bois_sciage_style2);?>
						<?php HtmlOutput::select('colonnes_bois_sciage3',$html_colonnes_bois_sciage3,$html_colonnes_bois_sciage_value3,$html_colonnes_bois_sciage3_js,$html_colonnes_bois_sciage_style3);?>
						<?php HtmlOutput::select('colonnes_bois_sciage4',$html_colonnes_bois_sciage4,$html_colonnes_bois_sciage_value4,$html_colonnes_bois_sciage4_js,$html_colonnes_bois_sciage_style4);?>
					</li>
					...
					<li id="attache_bois_sciage_box"<?php echo $html_attache_bois_sciage_style;?>>
						<label><?php echo __d( 'cecobois', 'Type d\'attache' ); ?></label>

						<?php HtmlOutput::select('attache_bois_sciage',$html_attache_bois_sciage,$html_attache_bois_sciage_value,$html_attache_bois_sciage_js);?>
					</li>
				</ul>
				...
				<ul id="bois_scl"<?php echo $html_classe_bois_scl_style;?>>
					...
					<li id="attache_bois_scl_box"<?php echo $html_attache_bois_scl_style;?>>
						<label><?php echo __d( 'cecobois', 'Type d\'attache' ); ?></label>

						<?php HtmlOutput::select('attache_bois_scl',$html_attache_bois_scl,$html_attache_bois_scl_value,$html_attache_bois_scl_js);?>
					</li>
				</ul>
				...
				<ul id="bois_blc_nordic"<?php echo $html_classe_bois_blc_nordic_style;?>>
						...
						<li class="mesure">
								...
								<?PHP HtmlOutput::select('profondeur228_bois_blc_nordic',$html_profondeur228_bois_blc_nordic,$html_profondeur228_bois_blc_nordic_value,$html_profondeur228_bois_blc_nordic_js,$html_profondeur228_bois_blc_nordic_style,'profondeur228_bois_blc_nordic',' mesure_valeur');?>
								<?PHP HtmlOutput::select('profondeur279_bois_blc_nordic',$html_profondeur279_bois_blc_nordic,$html_profondeur279_bois_blc_nordic_value,$html_profondeur279_bois_blc_nordic_js,$html_profondeur279_bois_blc_nordic_style,'profondeur279_bois_blc_nordic',' mesure_valeur');?>
								<?PHP HtmlOutput::select('profondeur327_bois_blc_nordic',$html_profondeur327_bois_blc_nordic,$html_profondeur327_bois_blc_nordic_value,$html_profondeur327_bois_blc_nordic_js,$html_profondeur327_bois_blc_nordic_style,'profondeur327_bois_blc_nordic',' mesure_valeur');?>
				...
				<ul>
					<li class="mesure">
						<label><span class="ast">*</span> <?php echo __d( 'cecobois', 'Hauteur' ); ?> (<span class="mesure_unite"><?php $unit = ($post->systeme == "met") ? __d( 'cecobois', 'm' ) : 'pieds'; echo $unit; ?></span>) :</label>

						<?php HtmlOutput::input('hauteur',$html_hauteur_js)?>
					</li>

					<li>
						<label><?php echo __d( 'cecobois', 'Coefficient de longueur, K<sub>e</sub>' ); ?></label>

						<?php HtmlOutput::select('coef_longueur_efficace',$html_coef_longueur_efficace,$html_coef_longueur_efficace_value,$html_coef_longueur_efficace_js);?>
					</li>

					<li>
						<label><?php echo __d( 'cecobois', 'Axe faible retenu' ); ?></label>

						<?php HtmlOutput::select('axe_faible',$html_axe_faible,$html_axe_faible_value,$html_axe_faible_js);?>
					</li>
			...
			<fieldset class="item-container">
				...
				<ul>
					<li class="mesure">
						<label><span class="ast">*</span> <?php echo __d( 'cecobois', 'Neige' ); ?> (<span class="mesure_unite"><?php $unit = ($post->systeme == "met") ? __d( 'cecobois', 'kN' ) : __d( 'cecobois', 'lb' ); echo $unit;?></span>)</label>
						<?php HtmlOutput::input('ax_neige',$html_ax_neige_js)?>
					</li>

					<li class="mesure">
						<label><span class="ast">*</span> <?php echo __d( 'cecobois', 'Surcharge' ); ?> (<span class="mesure_unite"><?php $unit = ($post->systeme == "met") ? __d( 'cecobois', 'kN' ) : __d( 'cecobois', 'lb' ); echo $unit;?></span>)</label>
						<?php HtmlOutput::input('ax_surcharge',$html_ax_surcharge_js)?>
					</li>

					<li class="mesure">
						<label><span class="ast">*</span> <?php echo __d( 'cecobois', 'Permanente' ); ?> (<span class="mesure_unite"><?php $unit = ($post->systeme == "met") ? __d( 'cecobois', 'kN' ) : __d( 'cecobois', 'lb' ); echo $unit;?></span>)</label>
						<?php HtmlOutput::input('ax_permanente',$html_ax_permanente_js)?>
					</li>

					<li class="mesure">
						<label><span class="ast">*</span> <?php echo __d( 'cecobois', 'Excentricité' ); ?> (<span class="mesure_unite"><?php $unit = ($post->systeme == "met") ? __d( 'cecobois', 'mm' ) : __d( 'cecobois', 'pouces' ); echo $unit; ?></span>)</label>
			...
			<fieldset class="item-container">
				...
				<ul>
					<li class="mesure">
						<label><span class="ast">*</span> <?php echo __d( 'cecobois', 'Vent' ); ?> (<span class="mesure_unite"><?php $unit = ($post->systeme == "met") ? __d( 'cecobois', 'kN/m' ) : __d( 'cecobois', 'lb/pi' ); echo $unit;?></span>)</label>
	...
	<div class="schematics-image" id="schema">
		<?php
			//if( Configure::read( 'Config.language' ) == 'fr' ) {
				$diagramPath = '/calculatrices-en-ligne/img/calculators/colonnes-imperial/schema.png';
			//} else {
			//	$diagramPath = '/img/calculators/colonnes-imperial/schema_en.png';
			//}
		?>
