...
<div class="left full main-content" id="reponse">
	...
	<div id="note">
		...
		<ol>
			<li><?php echo __d( 'cecobois', 'Les séries de poutrelles de bois en I sont basées sur les résistances génériques décrites dans le <em>Guide de conception sur les poutrelles de bois en I pour la construction commerciale</em> publié par Cecobois. Se référer aux fabricants afin d\'obtenir un dimensionnement plus précis en fonction de leurs produits respectifs.' ); ?></li>
			<li><?php echo __d( 'cecobois', 'Le calcul des poutrelles de bois en I présume qu\'il y a un support latéral aux points d\'appui afin d\'empêcher le déplacement latéral et la rotation, de même que le long de toutes les rives comprimées, prévenant ainsi le flambage de la semelle supérieure (article 13.2.5.2).' ); ?></li>
			<li><?php echo __d( 'cecobois', 'Le calcul des poutrelles de bois en I présume que les poutrelles sont en bois non traité utilisées en milieu sec (K<sub>T</sub> = 1,00 et K<sub>S</sub> = 1,00).' ); ?></li>
			<li><?php echo __d( 'cecobois', 'Le calcul des poutrelles de bois en I ne vérifie pas la résistance à l\'appui d\'extrémité. Se réferer au <em>Guide de conception</em> pour diverses options permettant d\'augmenter la résistance à l\'appui.' ); ?></li>
			<!--<li>Le calcul des poutrelles de bois en I ne vérifie pas la résistance en flexion, en cisaillement et à l'écrasement, ni la flèche des sablières ou des poutres les supportant.</li>-->
			...
			<li><?php echo __d( 'cecobois', 'Pour de plus amples informations sur les poutrelles de bois en I, veuillez communiquer avec les conseillers techniques par courriel à' ); ?> <a href="mailto:info@cecobois.com">info@cecobois.com</a>.</li>
		</ol>
	</div>
	...
	<a href="/calculatrices-en-ligne/poutrelles-imperial" class="btn-prev"><?php echo __d( 'cecobois', 'Retour à la calculatrice' ); ?></a>
</div>