		...
		<form name="calcul" method="post" id="calc">
			<fieldset class="item-container">
				<ul>
					...
					<li class="mesure">
						<label><span class="ast">*</span> <?php echo __d( 'cecobois', 'Portée' ); ?> (<span class="mesure_unite"><?php $unit = ($post->systeme == "met") ? __d( 'cecobois', 'm' ) : __d( 'cecobois', 'pieds' ); echo $unit;?></span>)</label>
			...
			<fieldset class="item-container">
				...
				<ul>
					<li class="mesure">
						<label><span class="ast">*</span> <?php echo __d( 'cecobois', 'Charge permanente' ); ?> D<sub>1</sub> (<span class="mesure_unite"><?php $unit = ($post->systeme == "met") ? 'kPa' : 'lb/pi<sup>2</sup>'; echo $unit;?></span>)</label>

						<?php HtmlOutput::input('morte_sup',$html_morte_sup_js,' mesure_valeur')?>
					</li>

					<li class="mesure">
						<label><span class="ast">*</span> <?php echo __d( 'cecobois', 'Charge permanente' ); ?> D<sub>2</sub> (<span class="mesure_unite"><?php $unit = ($post->systeme == "met") ? 'kPa' : 'lb/pi<sup>2</sup>'; echo $unit;?></span>)</label>

						<?php HtmlOutput::input('morte_inf',$html_morte_inf_js,' mesure_valeur')?>
					</li>
				</ul>
			</fieldset>
			...
			<fieldset class="item-container">
				...
				<ul id="assemblage">
					...
					<li>
						<label><span class="ast">*</span> <?php echo __d( 'cecobois', 'Raidisseurs continus en 2x6' ); ?></label>
...
<div class="right project-right calculator-container">
	<div class="schematics-image" id="schema">
		<?php
			$diagramPath = '/calculatrices-en-ligne/img/calculators/poutrelles-aj-imperial/schema.png';
		?>
