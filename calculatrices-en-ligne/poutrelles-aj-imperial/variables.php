<?PHP
	...
	define ('ERROR_MORTE_SUP_NOMBRE', __d( 'cecobois', 'La charge permanente D<sub>1</sub> entrée n\'est pas un nombre.' ) );
	define ('ERROR_MORTE_SUP_BIGGER', __d( 'cecobois', 'La charge permanente D<sub>1</sub> entrée est trop grande. Le maximum autorisé est de 10kPa (208.85 lb/pi<sup>2</sup>).' ) );
	define ('ERROR_MORTE_SUP_SMALLER', __d( 'cecobois', 'La charge permanente D<sub>1</sub> entrée est trop petite. Le minimum autorisé est de 0,25kPa (5.23 lb/pi<sup>2</sup>).' ) );


	define ('ERROR_MORTE_INF_NOMBRE', __d( 'cecobois', 'La charge permanente D<sub>2</sub> entrée n\'est pas un nombre.' ) );
	define ('ERROR_MORTE_INF_BIGGER', __d( 'cecobois', 'La charge permanente D<sub>2</sub> entrée est trop grande. Le maximum autorisé est de 10kPa (208.85 lb/pi<sup>2</sup>).' ) );
	define ('ERROR_MORTE_INF_SMALLER', __d( 'cecobois', 'La charge permanente D<sub>2</sub> entrée est trop petite. Le minimum autorisé est de 0,25kPa (5.23 lb/pi<sup>2</sup>).' ) );
	...
	if($post->action=="send"){
		...
		$html_morte_sup_js				= ' onclick="confirm_cache_form();" onfocus="confirm_cache_form(); this.blur();"';
		$html_morte_inf_js				= ' onclick="confirm_cache_form();" onfocus="confirm_cache_form(); this.blur();"';
