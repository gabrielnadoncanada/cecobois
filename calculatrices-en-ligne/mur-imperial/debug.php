...
<table cellpadding="0" cellspacing="2" border="1"><tbody>
	<tr>
		<td>Coeficient Elancement</td>
		<td><?php echo $coeficient_elancement; ?></td>
	</tr>
</tbody></table>
...
<table cellpadding="0" cellspacing="2" border="1"><tbody>
	...
	<tr>
		<td>Kzb</td>
		<td><?php echo $classe->kzb; ?></td>
	</tr>
	<tr>
		<td>Kzv</td>
		<td><?php echo $classe->kzv; ?></td>
	</tr>
	<tr>
		<td>Kzc</td>
		<td><?php echo $classe->kzc; ?></td>
	</tr>
	<tr>
		<td>Khb</td>
		<td><?php echo $classe->khb; ?></td>
	</tr>
	<tr>
		<td>Khv</td>
		<td><?php echo $classe->khv; ?></td>
	</tr>
	<tr>
		<td>Khc</td>
	...
	<tr>
		<td>Densite Bois</td>
		<td><?php echo $classe->densite_bois; ?></td>
	</tr>
</tbody></table>
...
<table cellpadding="0" cellspacing="2" border="1"><tbody>
	<tr>
		<td>Volume</td>
		<td><?php echo $colombages->volume_bois; ?></td>
	</tr>
	<tr>
		<td>Poids</td>
		<td><?php echo $colombages->poids; ?></td>
	</tr>
	<tr>
		<td>Poids par mètre linéaire</td>
		<td><?php echo $colombages->poids_metre_lineaire; ?></td>
	</tr>
</tbody></table>
...
<table cellpadding="0" cellspacing="2" border="1"><tbody>
	...
	<tr>
		...
		<td><?php echo $tab_kc[$a]; ?></td>
		<td><?php echo $tab_vf[$a]; ?></td>
		<td><?php echo $tab_vr[$a]; ?></td>
		<td><?php echo $tab_vf_sur_vr[$a]; ?></td>
...
<table cellpadding="0" cellspacing="2" border="1"><tbody>
	...
	<tr>
		<td><?php echo $a+1; ?></td>
		<td><?php echo $o_slash; ?></td>
		<td><?php /*echo ($classe->fcp * $Kd_tmp[$a]);*/ echo $classe->fcp * $tab_kd[$a]; ?></td>
		<td><?php echo $classe->fcp; ?></td>
		<td><?php /* echo $Kd_tmp[$a];*/ echo $tab_kd[$a]; ?></td>
		<td><?php echo ($post->largeur * $post->profondeur); ?></td>
		<td><?php echo $post->largeur; ?></td>
		<td><?php echo $post->profondeur; ?></td>
		<td><?php echo $kb; ?></td>
		<td><?php echo $kzcp; ?></td>
		<td><?php echo $tab_pf[$a]; ?></td>
		<td><?php echo $tab_ecrasement_qr[$a]; ?></td>
		<td><?php echo $tab_ecrasement_lisse[$a]; ?></td>
	</tr>
	<?php endfor; ?>
