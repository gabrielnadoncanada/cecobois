...
?>
     ...
     <script type="text/javascript" src="/calculatrices-en-ligne/js/calculators/mur-imperial/script.js" language="javascript"></script>
    <script type="text/javascript" src="/calculatrices-en-ligne/js/calculators/mur-imperial/swap_systeme.js" language="javascript"></script>
</body>
</html>