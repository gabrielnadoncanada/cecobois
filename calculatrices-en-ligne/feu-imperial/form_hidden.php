<div class="calculator-terms text" id="absolute">
	<div id="box_absolute">
		<h2 class="green-title"><?php echo __d( 'cecobois', 'Calculatrice de degré de résistance au feu' ) . ' - ' . __d( 'cecobois', 'Conditions d\'utilisation' ); ?></h2>
		...
		<div id="content">
			...
			<form name="calcul_hidden" method="post" id="formulaire">
				...
				<?PHP
					...
					HtmlOutput::hidden('type_element');
					HtmlOutput::hidden('largeur');
					HtmlOutput::hidden('profondeur');
					HtmlOutput::hidden('portee');
					HtmlOutput::hidden('coef');
					HtmlOutput::hidden('faces');
					HtmlOutput::hidden('sollicitation');
				?>
