...
<script type="text/javascript" src="/js/calculators/mur/script.js" language="javascript"></script>

<?php if( $post->action == 'send' ):?>
	<script type="text/javascript" src="/js/calculators/script_clean.php" language="javascript"></script>
<?php endif;?>

<?php
	if( $show_debug && $post->action != '' ) {
