...
aff_select_profondeur_blc_nordic=function(sel){
	...
	doc215	=  document.getElementById('profondeur215_bois_blc_nordic');	
	doc241	=  document.getElementById('profondeur241_bois_blc_nordic');	
	doc292	=  document.getElementById('profondeur292_bois_blc_nordic');	

	var tab_docId=Array(doc86,doc137,doc184,doc215,doc241,doc292);
	ResetDisplayNone(tab_docId);
...
aff_select_profondeur_bois_massif=function(sel,type){
	...
	doc343	=  document.getElementById('profondeur343_bois_massif');
	doc394	=  document.getElementById('profondeur394_bois_massif');
	...
	doc292_2	=  document.getElementById('profondeur292_2_bois_massif');
	doc343_2	=  document.getElementById('profondeur343_2_bois_massif');
	doc394_2	=  document.getElementById('profondeur394_2_bois_massif');

	var tab_docId=Array(doc140,doc191,doc241,doc292,doc343,doc394,doc140_2,doc191_2,doc241_2,doc292_2,doc343_2,doc394_2);
	ResetDisplayNone(tab_docId);
	...
	if(type == 1){
		switch(sel.value){
			...
			case '292':
				...
				break;	
			case '343':
				doc343.style.display = "block";
				break;	
			case '394':
				doc394.style.display = "block";
				break;	
		}
	}
	else{
		switch(sel.value){
			...
			case '241':
				...
				break;
			case '292':
				doc292_2.style.display = "block";
				break;
			case '343':
				doc343_2.style.display = "block";
				break;
			case '394':
				doc394_2.style.display = "block";
				break;
		}
...
aff_intervalles=function(sel){
	if(sel.value == 'intervalles'){
		document.getElementById('intervalles').style.display = "block";
	}
	else{
		document.getElementById('intervalles').style.display = "none";
	}
}
