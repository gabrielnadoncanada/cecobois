<?PHP
	class HtmlOutput{
		...
		function select($name_select,$donnees,$donnees_value,$change='',$style='',$id_select=''){
			global $post;
			...
			if($post->action=="print"){
				...
				$select ="\n";
				$select .= '<select name="'.$name_select.'"'.$id_select.''.$change.$style.' class="inputbox">';
				$select .="\n";
		...
		function radio($name_radio,$donnees,$donnees_value,$change='',$style='',$td_actif=0,$id_radio=''){
			global $post;
