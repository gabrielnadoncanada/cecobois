...
function fct_type_constr(type_constr){
	...
	if(type_constr.value == "ossature"){
		...
		document.getElementById('tr_syst_struc1').style.display="";
		...
		document.getElementById('tr_syst_struc2').style.display="";
	}
}
...
function fct_syst_struc1(syst_struc1){
	...
	if(syst_struc1.value == "mur"){
		...
		document.getElementById('tr_porteur').style.display="";
		...
		document.getElementById('tr_paroi3').style.display="";
		...
		document.getElementById('tr_paroi4').style.display="";
		...
		document.getElementById('tr_paroi5').style.display="";
...
function fct_porteur(porteur){
	...
	if(porteur.value == "oui"){
		...
		document.getElementById('tr_espacement1').style.display="";
		document.getElementById('tr_paroi1').style.display="";
		document.getElementById('tr_isolant1').style.display="";
		
	}else if(porteur.value == "non"){
		
		resetFields(Array('espacement1','paroi1','isolant1'));
		
		document.getElementById('tr_espacement2').style.display="";
		document.getElementById('tr_paroi2').style.display="";
...
function fct_paroi2(paroi2){
	...
	if(paroi2.value == "12.7" || paroi2.value == "15.9"){
		document.getElementById('tr_isolant2').style.display="";
	}else{
...
function fct_syst_struc2(syst_struc2){
	...
	if(syst_struc2.value == "mur"){
		...
		document.getElementById('tr_elements1').style.display="";
		...
		document.getElementById('tr_elements2').style.display="";
...
function fct_elements1(elements1){
	...
	if(elements1.value == "mvp"){
		...
		document.getElementById('tr_dimensions1').style.display="";
		document.getElementById('tr_paroi6').style.display="";
		
	}else if(elements1.value == "mhnp"){
		
		resetFields(Array('dimensions1','paroi6'));	
		document.getElementById('tr_dimensions2').style.display="";
		document.getElementById('tr_paroi7').style.display="";
...
function fct_elements2(elements2){
	...
	if(elements2.value == "msc"){
		...
		document.getElementById('tr_dimensions3').style.display="";
		document.getElementById('tr_paroi8').style.display="";
		
	}else if(elements2.value == "prl"){
		
		resetFields(Array('dimensions3','paroi8'));	
		document.getElementById('tr_dimensions4').style.display="";
		document.getElementById('tr_paroi9').style.display="";
